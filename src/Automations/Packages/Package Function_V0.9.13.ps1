...
function New-SCCMDeployments {
    ...
    Write-Host "Available Program: $($Programs.Available)"
    Write-Host "Install Program: $($Programs.Install)"
    Write-Host "Uninstall Program: $($Programs.Uninstall)"

    Write-Host "Available Collection: $($Collections.Available)"
    Write-Host "Install Collection: $($Collections.Install)"
    Write-Host "Uninstall Collection: $($Collections.Uninstall)"
...
function Move-SCCMPackageToFolder {
    ...
    Write-Host "Moved Package: $($meta.PackageName)" -ForegroundColor Green
}
