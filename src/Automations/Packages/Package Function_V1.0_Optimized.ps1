...
# Generated by ChatGPT on 2026-05-18
#
# Automated improvements applied:
# - Replaced Get-PackageDetails calls with Get-PCXPackageMetadata
# - Standardized Get-PCXPackageMetadata parameter usage
# - Removed unnecessary Set-Location C:
# - Replaced Get-ChildItem -Path with -LiteralPath
#
# Recommended manual improvements still to consider:
# - Remove duplicate Get-PackageDetails function definitions
# - Connect to SCCM only once in Create-PCXPackage
# - Cache Get-CMSupportedPlatform results
# - Build file map once and reuse
# - Add [datetime]$DeadlineTime parameter to Create-PCXPackage
# ============================================
